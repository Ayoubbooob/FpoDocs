          ...
          child: ListView(
            ...
            children: <Widget>[
              // Text('LOGIN', style: TextStyle(fontWeight: FontWeight.bold)),
                  ...
                  Container(height: 190,child: SingleChildScrollView(child:Column(children:<Widget>[
                    Center(child: Container(margin: EdgeInsets.only(top :35), child: Text("LOGIN" , style: TextStyle(color: Colors.black54, fontSize: 20,fontWeight: FontWeight.bold),),),),
              ...
              Positioned(
              child:RoundedInputField(hintText: "Entrez votre email", onChanged: (value) {},icon: Icons.email,label: 'Email',
              validator: (text){
